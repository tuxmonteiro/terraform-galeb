resource "aws_cloudwatch_metric_alarm" "TcpResetFromTargets" {
    ...
    threshold           = "150.0"
    alarm_description   = ""
    alarm_actions       = ["arn:aws:autoscaling:sa-east-1:185565106143:scalingPolicy:be1729cc-b07e-407a-a8d2-2499ee716743:autoScalingGroupName/galeb-as-dev-01:policyName/galebTcpResetFromTargets"]
    dimensions {
        LoadBalancer = "net/galeb-aws-be8/7ed4f89cf35fff3e"
    }
}

resource "aws_cloudwatch_metric_alarm" "awsec2-galeb-as-dev-01-CPU-Utilization" {
...
resource "aws_cloudwatch_metric_alarm" "awsec2-galeb-as-dev-01-High-CPU-Utilization" {
    ...
    threshold           = "30.0"
    alarm_description   = ""
    alarm_actions       = ["arn:aws:autoscaling:sa-east-1:185565106143:scalingPolicy:f7dcc8d6-cccb-468f-8276-d7082a0ddecb:autoScalingGroupName/galeb-as-dev-01:policyName/galebCpuAvgDown"]
    dimensions {
        AutoScalingGroupName = "galeb-as-dev-01"
    }
}
